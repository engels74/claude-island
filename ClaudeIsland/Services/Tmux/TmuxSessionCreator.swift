...
actor TmuxSessionCreator {
    ...
    func launch(
        ...
        let hookReceived = await SessionStore.shared.awaitLaunchMerge(provisionalID: provisionalID)
    ...
    static func resolveTemplate(_ template: String, name: String, directory: String) -> String {
        let formatter = DateFormatter()
